...
const Project = {
  ...
  challenges: <p>I ran into a few challenges initially with the shopify site. With it being my first dive into shopify I had to become familiar with how things are set up including products and themes as well as its limitations. Though after learning some of liquid and shopify's data schema I was quickly able to start making custom sections in liquid.</p>,
  takeaways: <p>My takeaways from this project are mostly mixed. I’m happy I went with Shopify for the ecommerce and point of sale platform as it still seems to be the best on the market. However I was not impressed with the site speed performance. Using a free starter theme and a few custom sections I was hoping for better results. In the future I might look into other frontend options. Such as purchasing a more optimized theme, building my own custom theme, or move to Gatsby JS with the Shopify Store front API.</p>
};
