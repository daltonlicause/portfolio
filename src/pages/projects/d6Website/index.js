...
const Project = {
  ...
  stackExplained: <p>Since I had been using React for a while and heard good things about Gatsby/ JAM stack sites, I decided this would be a good fit for it. I also found it to be a good opportunity to finally learn and try out GatsbyJS. Out of the gate, converting to a static site fixed most load time and SEO issues their Wordpress website had struggled with. The addition of Netlify CMS and GraphQL gave me the able to create pages that their internal team could easily add and update. Styling was custom and handled with my personal favorite-Styled Components.</p>,
  challenges: <p>At the time I had yet to learn GatsbyJS and with that GraphQL, so initially there was some time I had to spend reading documentation and finding solutions to the problems I ran into. All in all, though I had very few issues and those that I did run into were relatively easy to find a solution for. Thanks to their already large community GatsbyJS has tons of forms and threads realted to most issues.</p>,
  takeaways: <p>My takeaway from this project was my new found appreciation for GatsbyJS and Static Sites. After years of working with Wordpress, it was a breath of fresh air and I don’t think I could ever go back. Having the ability to quickly build static sites with React and Gatsby is immensely more enjoyable and by far less of a headache.</p>
};
