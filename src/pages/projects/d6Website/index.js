...
const Project = {
  ...
  stackExplained: <p>Since I had been using React for a while and heard good things about Gatsby/ JAM stack sites, I decided this was the perfect fit for a React/ GatsbyJS Static Site. I also found it to be a good opportunity to finally learn and try out GatsbyJS. Out of the gate the load time and SEO issues their Wordpress website had been mostly solved with the static GatsbyJS site. Then with the addition of Netlify CMS and GraphQL I was able to create pages that their internal team could easily add and update. As for styling I went with my person favorite - Styled Components.</p>,
  challenges: <p>At the time I had yet to learn GatsbyJS and with that GraphQL. Initially there was some time I had to spend reading documentation and finding solutions to the problems I ran into. All in all though the site had very few challenges and those that I ran into we’re relatively easy to find a solution for. Thanks to the already large community GatsbyJS had many forms and threads realted to most issues.</p>,
