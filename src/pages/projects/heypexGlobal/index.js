...
const Project = {
  ...
  goals: <p>At Heypex Global we wanted to build a new site that housed more pages, content, and functionality than our current single page add site at the time. The site also needed to convey more of what the business is and visually appeal to more clients.</p>,
  ...
  challenges: <p>After already learning the initial build out of a Gatsby site with Netlify CMS/ GraphQL I didn’t run into much issue with this project. It was more of the same, but at a larger scale with more content. Some of the challenges that did arise came from the file structure, organization, and setup of some custom data objects in Netlify CMS.</p>,
