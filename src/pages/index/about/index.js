  ...
  return (
    <section className="about">
      ...
      <div className="sub-section">
        <p className="section-headline">Welcome to my portfolio! I am a full stack software engineer from Northwest Arkansas with 7+ years of hands-on experience. I have a passion for creating pixel perfect front-end applications with the technical ability to build scalable back-end services.</p>
      </div>
      <div className="sub-section">
